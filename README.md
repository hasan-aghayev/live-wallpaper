...
3. Выберите громкость, режим масштабирования и затемнение. Настройки применяются автоматически; кнопка `Save settings` внизу сохраняет и повторно применяет их все сразу.
